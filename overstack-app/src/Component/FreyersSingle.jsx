...
import { Button, Icon, useTab, useToast } from '@chakra-ui/react'
...
const  FreyersSingle = () => {
  const toast=useToast()
    ...
    React.useEffect(()=>{
      axios.get(`https://stock-server.onrender.com/fryers/${id}`)
    ...
    return (
      <div className='Single'>
        ...
        <div className='btn'>
        <Link to="/fryer"><Button bg="grey">Go Back</Button></Link> 
